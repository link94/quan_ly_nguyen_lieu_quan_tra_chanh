...
public class employeescennn extends AppCompatActivity {
...
private ActivityEmployeescennnBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     setContentView(binding.getRoot());
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_nguyen_lieu, R.id.nav_san_pham, R.id.nav_menu)
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_logout) {
            Intent intent = new Intent(employeescennn.this, login.class);
